    ...
    public class TvServicePaymentController : Controller
    {
                ...
                if (dResponse != null && dResponse.Rows.Count > 0)
                {
                    ...
                    if (dVianetPayment != null && dVianetPayment.Rows.Count > 0)
                    {
                        ...
                        foreach (var item in lines)
                        {
                            ...
                            result = Regex.Replace(result, "packageval", "package val ");
                            result = Regex.Replace(result, "bonus", " bounus");
                            list.Add(result);
        ...
        public async Task<ActionResult> SIMTVExecutePayment(ISP iSP)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                var destinationTestNumber = System.Configuration.ConfigurationManager.AppSettings["DestinationTestNumber"];
                var destinationMerchantId = System.Configuration.ConfigurationManager.AppSettings["DestinationMerchantIdPaypoint"];
                var action = "TVServicePayment.svc/SIMTVexecutepayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                string tokenID = Session["TokenID"].ToString();
                var content = new FormUrlEncodedContent(new[]{
                        new KeyValuePair<string, string>("vid", destinationMerchantId),//default
                        ...
                        new KeyValuePair<string, string>("src","http"), ////default
                        new KeyValuePair<string, string>("tokenID",tokenID),//default
                        new KeyValuePair<string, string>("companyCode", "595"),//default
        ...
        //Mero TV
        #region "GET: MeroTV Index"
        public ActionResult MeroTV()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
        ...
        #region "POST: MeroTV CheckPayment"
        [HttpPost]

        public async Task<ActionResult> MeroTVCheckPayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                var action = "TVServicePayment.svc/MeroTVcheckpayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                ...
                var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("src","http"),
                        new KeyValuePair<string, string>("tokenID",tokenID),
                        new KeyValuePair<string, string>("companyCode", "762"),
                        new KeyValuePair<string, string>("serviceCode", "0"),
                        new KeyValuePair<string, string>("account", iSP.CustomerID),
                        new KeyValuePair<string, string>("special1",iSP.CustomerID),
                        new KeyValuePair<string, string>("special2",""),
                        new KeyValuePair<string, string>("tid", tid),
                        new KeyValuePair<string, string>("ClientCode", clientCode),
                        new KeyValuePair<string, string>("paypointType", "MeroTV"),
        ...
        #region "GET: MeroTV Details"
        public ActionResult MeroTVDetails()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                DataSet DPaypointSet = PaypointUtils.GetMeroTVDetails(NWObj);
                DataTable dResponse = DPaypointSet.Tables["dtResponse"];
                DataTable dVianetPayment = DPaypointSet.Tables["dtNWPayment"];
                ...
                if (dResponse != null && dResponse.Rows.Count > 0)
                {
                    ...
                    if (dVianetPayment != null && dVianetPayment.Rows.Count > 0)
                    {
                        ...
                        regobj.smartCards = dVianetPayment.Rows[0]["SmartCards"].ToString();
                        regobj.CustomerName = dVianetPayment.Rows[0]["ReserveInfo"].ToString();
                        ...
                        string[] lines3 = regobj.smartCards.Split(new[] { Environment.NewLine }, StringSplitOptions.None); //to split string to new line
                        lines3 = lines3.Take(lines3.Length - 1).ToArray();  //to remove last list which is empty 
                    ...
                    {
                        return RedirectToAction("MeroTV");
                    }
                }
                else
                {
                ...
                ViewBag.CustomerName = regobj.CustomerName.ToString();
                ViewBag.NWBranchCode = regobj.NWBranchCode.ToString();
                ViewBag.CustomerID = regobj.CustomerID;
                ViewBag.TotalAmountDue = regobj.TotalAmountDue;
                ViewBag.payPointType = regobj.payPointType;
        ...
        #region "POST: MeroTV ExecutePayment"
        [HttpPost]
        public async Task<ActionResult> MeroTVExecutePayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                var destinationTestNumber = System.Configuration.ConfigurationManager.AppSettings["DestinationTestNumber"];
                var destinationMerchantId = System.Configuration.ConfigurationManager.AppSettings["DestinationMerchantIdPaypoint"];
                var action = "TVServicePayment.svc/MeroTVexecutepayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                string tokenID = Session["TokenID"].ToString();
                var content = new FormUrlEncodedContent(new[]{
                        new KeyValuePair<string, string>("vid", destinationMerchantId),//default
                        ...
                        new KeyValuePair<string, string>("src","http"), ////default
                        new KeyValuePair<string, string>("tokenID",tokenID),//default
                        new KeyValuePair<string, string>("companyCode", "762"),//default
                        new KeyValuePair<string, string>("serviceCode", regobj.ServiceCode),//default
                        new KeyValuePair<string, string>("account",  regobj.CustomerID),//user
                        new KeyValuePair<string, string>("special1",regobj.CustomerID),//user
                        new KeyValuePair<string, string>("special2", ""),//user
        ...
        public ActionResult Sky()
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                ViewBag.DHServiceCode = PaypointUtils.GetSkyTvServiceCode();
                ViewBag.SenderMobileNo = userName;
        ...
        public async Task<ActionResult> SkyCheckPayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                var action = "TVServicePayment.svc/Skycheckpayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                ...
                var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("src","http"),
                        new KeyValuePair<string, string>("tokenID",tokenID),
                        new KeyValuePair<string, string>("companyCode", "799"),
                        new KeyValuePair<string, string>("serviceCode", iSP.DHServiceCode),
                        new KeyValuePair<string, string>("account", iSP.CustomerID),
                        new KeyValuePair<string, string>("special1",iSP.DHServiceCode),
                        new KeyValuePair<string, string>("special2",""),
                        new KeyValuePair<string, string>("tid", tid),
                        new KeyValuePair<string, string>("ClientCode", clientCode),
                        new KeyValuePair<string, string>("paypointType", "Sky Internet/TV")
                    });
                _res = await client.PostAsync(new Uri(uri), content);
                string responseBody = _res.StatusCode.ToString() + " ," + await _res.Content.ReadAsStringAsync();
                _res.ReasonPhrase = responseBody;
        ...
        #region "GET: Sky Details"
        public ActionResult SkyDetails()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                DataSet DPaypointSet = PaypointUtils.GetSkyTVDetails(NWObj);
                DataTable dResponse = DPaypointSet.Tables["dtResponse"];
                DataTable dVianetPayment = DPaypointSet.Tables["dtNWPayment"];
        ...
        #region "POST: SkyTV ExecutePayment"
        [HttpPost]
        public async Task<ActionResult> SkyTVExecutePayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                var destinationTestNumber = System.Configuration.ConfigurationManager.AppSettings["DestinationTestNumber"];
                var destinationMerchantId = System.Configuration.ConfigurationManager.AppSettings["DestinationMerchantIdPaypoint"];
                var action = "TVServicePayment.svc/SkyTVexecutepayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                string tokenID = Session["TokenID"].ToString();
                var content = new FormUrlEncodedContent(new[]{
                        new KeyValuePair<string, string>("vid", destinationMerchantId),//default
                        ...
                        new KeyValuePair<string, string>("src","http"), ////default
                        new KeyValuePair<string, string>("tokenID",tokenID),//default
                        new KeyValuePair<string, string>("companyCode", "799"),//default
                        new KeyValuePair<string, string>("serviceCode", regobj.ServiceCode),//default
                        new KeyValuePair<string, string>("account",  regobj.CustomerID),//user
                        new KeyValuePair<string, string>("special1",regobj.CustomerID),//user
                        new KeyValuePair<string, string>("special2", ""),//user
        ...
        public ActionResult NetTv()
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                ViewBag.DHServiceCode = PaypointUtils.GetNetTvVoucher();
                ViewBag.SenderMobileNo = userName;
        ...
        public async Task<ActionResult> NetTvCheckPayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                var action = "TVServicePayment.svc/NetTvCheckpayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                ...
                var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("src","http"),
                        new KeyValuePair<string, string>("tokenID",tokenID),
                        new KeyValuePair<string, string>("companyCode", "579"),
                        new KeyValuePair<string, string>("serviceCode", iSP.DHServiceCode),
                        new KeyValuePair<string, string>("account", iSP.CustomerID),
                        new KeyValuePair<string, string>("special1",""),
                        new KeyValuePair<string, string>("special2",""),
                        new KeyValuePair<string, string>("tid", tid),
                        new KeyValuePair<string, string>("ClientCode", clientCode),
                        new KeyValuePair<string, string>("paypointType", "NetTv"),
