...
{
    public class LoadFundController : Controller
    {
        DAL objdal = new DAL();
        #region "GET: Khalti Index"
        public ActionResult Khalti()
        {
        ...
        #region "POST: Khalti CheckPayment"
        [HttpPost]

        public async Task<ActionResult> KhaltiCheckPayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            {
                var action = "LoadFund.svc/KhaltiCheckPayment";
                ...
                var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("companyCode", "910"),
                        ...
                        new KeyValuePair<string, string>("paypointType", "Khalti"),
        ...
        #region "GET: Khalti Details"
        public ActionResult KhaltiDetails()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                DataSet DPaypointSet = PaypointUtils.GetKhaltiDetails(NWObj);
                ...
                if (dResponse != null && dResponse.Rows.Count > 0)
                {
                    ...
                    {
                        return RedirectToAction("Khalti");
                    }
                }
                else
                {
                ...
                ViewBag.TotalAmountDue = regobj.billAmount;
        ...
        #region "POST: Khalti ExecutePayment"
        [HttpPost]
        public async Task<ActionResult> KhaltiExecutePayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
