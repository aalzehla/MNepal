...
namespace CustApp.Controllers
{
    public class ISPController : Controller
    {
        ...
        DAL objdal = new DAL();
        #region "GET: WebSurfer Index"
        public ActionResult WebSurfer()
        {
            string userName = "";
            ...
            try
            {
                userName = (string)Session["LOGGED_USERNAME"];
        ...
        #region "POST: WebSurfer CheckPayment"
        [HttpPost]

        public async Task<ActionResult> WebSurferCheckPayment(ISP iSP)
        {
            string userName = "";
            string clientIp = (Request.ServerVariables["HTTP_X_FORWARDED_FOR"] ??
                   Request.ServerVariables["REMOTE_ADDR"]).Split(',')[0].Trim();
            try
            {
                ...
                {
                    var action = "ISP.svc/WebSurferCheckPayment";
                    ...
                    var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("companyCode", "900"),
                        ...
                        new KeyValuePair<string, string>("paypointType", "WebSurfer"),
        ...
        #region "GET: WebSurfer Details"
        public ActionResult WebSurferDetails()
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                DataSet DPaypointSet = PaypointUtils.GetWebSurferDetails(NWObj);
                ...
                if (dResponse != null && dResponse.Rows.Count > 0)
                {
                    ...
                    if (dVianetPayment != null && dVianetPayment.Rows.Count > 0)
                    {
                        ...
                        regobj.CustomerName = dVianetPayment.Rows[0]["FtthUser"].ToString();
                        ...
                        string[] lines3 = regobj.CustomerName.Split(new[] { Environment.NewLine }, StringSplitOptions.None); //to split string to new line
        ...
        #region "POST: WebSurfer ExecutePayment"
        [HttpPost]
        public async Task<ActionResult> WebSurferExecutePayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
        ...
        #region "GET: ArrowNet Index"
        public ActionResult ArrowNet()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
        ...
        #region "POST: ArrowNet CheckPayment"
        [HttpPost]

        public async Task<ActionResult> ArrowNetCheckPayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                var action = "ISP.svc/ArrowNetCheckPayment";
                var uri = Path.Combine(ApplicationInitilize.WCFUrl, action);
                ...
                var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("src","http"),
                        new KeyValuePair<string, string>("tokenID",tokenID),
                        new KeyValuePair<string, string>("companyCode", "907"),
                        new KeyValuePair<string, string>("serviceCode", "0"),
                        new KeyValuePair<string, string>("account", iSP.CustomerID),
                        new KeyValuePair<string, string>("special1",iSP.CustomerID),
                        new KeyValuePair<string, string>("special2",""),
                        new KeyValuePair<string, string>("tid", tid),
                        new KeyValuePair<string, string>("ClientCode", clientCode),
                        new KeyValuePair<string, string>("paypointType", "ArrowNet"),
        ...
        #region "GET: ArrowNet Details"
        public ActionResult ArrowNetDetails()
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                DataSet DPaypointSet = PaypointUtils.GetArrowNetDetails(NWObj);
                DataTable dResponse = DPaypointSet.Tables["dtResponse"];
                DataTable dVianetPayment = DPaypointSet.Tables["dtNWPayment"];
                ...
                if (dResponse != null && dResponse.Rows.Count > 0)
                {
                    ...
                    if (dVianetPayment != null && dVianetPayment.Rows.Count > 0)
                    {
                        ...
                        foreach (var item in lines)
                        {
                            ...
                            packageResult = Regex.Replace(packageResult, "amount", " amount");
                            packageResult = Regex.Replace(packageResult, "currency", " currency");
                            packageResult = Regex.Replace(packageResult, "Duration", " Duration");
                            list.Add(packageResult);
        ...
        #region "POST: ArrowNet ExecutePayment"
        [HttpPost]
        public async Task<ActionResult> ArrowNetExecutePayment(ISP iSP)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                var content = new FormUrlEncodedContent(new[]{
                        ...
                        new KeyValuePair<string, string>("src","http"), ////default
                        new KeyValuePair<string, string>("tokenID",tokenID),//default
                        new KeyValuePair<string, string>("companyCode", "907"),//default
                        new KeyValuePair<string, string>("serviceCode", regobj.ServiceCode),//default
                        new KeyValuePair<string, string>("account",  regobj.CustomerID),//user
                        new KeyValuePair<string, string>("special1",packageId),//user
                        new KeyValuePair<string, string>("special2", ""),//user
