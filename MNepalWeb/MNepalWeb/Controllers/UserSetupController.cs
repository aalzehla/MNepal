...
namespace MNepalWeb.Controllers
{
    ...
    public class UserSetupController : Controller
    {
        ...
        public ActionResult CreateAdminProfile()
        {
            ...
            string userType = (string)Session["LOGGED_USERTYPE"];
            //Check Role link start          
            string methodlink = System.Reflection.MethodBase.GetCurrentMethod().Name; //get MethodName
            RoleChecker roleChecker = new RoleChecker();
            bool checkRole = roleChecker.checkRole(methodlink, clientCode);
            //Check Role link end
            TempData["userType"] = userType;
        ...
        [HttpPost]
        public ActionResult CreateAdminProfile(FormCollection collection)
        {
            //string userName = (string)Session["LOGGED_USERNAME"];
            //string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                return RedirectToAction("CreateAdminProfile", "UserSetup");
            }
            else
            {
                return RedirectToAction("Index", "Login");
        ...
        [HttpPost]
        public ActionResult EditAdminProfileSetup(FormCollection collection)
        {
            string name = (string)Session["LOGGEDUSER_NAME"];
            string userType = (string)Session["LOGGED_USERTYPE"];
