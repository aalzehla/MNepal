    ...
    public class RegisterUserModel
    {
            ...
            try
            {
                using (sqlCon = new SqlConnection(DatabaseConnection.ConnectionStr()))
                {
                    ...
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNAdminRegistration]", sqlCon))
                    {
                        ...
                        sqlCmd.Parameters.AddWithValue("@BankCode", objUserInfo.BankNo);
        ...
        public int RegisterUsersInfo(UserInfo objUserInfo)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNBankRegistration]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        ...
                        sqlCmd.Parameters.AddWithValue("@Nationality", objUserInfo.Nationality);
                        sqlCmd.Parameters.AddWithValue("@CountryCode", objUserInfo.Country);
                        sqlCmd.Parameters.AddWithValue("@DateOfBirth", DateTime.ParseExact(objUserInfo.DOB, "dd/MM/yyyy", CultureInfo.InvariantCulture)
                        ...
                        sqlCmd.Parameters.AddWithValue("@PassportNo", objUserInfo.Passport);
                        sqlCmd.Parameters.AddWithValue("@PassportPlaceOfIssue", objUserInfo.PassportPlaceOfIssue);
                        //sqlCmd.Parameters.AddWithValue("@LicenseExpiryDate", DateTime.Parse(objUserInfo.LicenseExpireDate));
                        //sqlCmd.Parameters.AddWithValue("@LicenseIssueDate", DateTime.Parse(objUserInfo.LicenseIssueDate));
                        //sqlCmd.Parameters.AddWithValue("@CitizenIssueDate", DateTime.Parse(objUserInfo.CitizenshipIssueDate));
                        //sqlCmd.Parameters.AddWithValue("@PassportIssueDate", DateTime.Parse(objUserInfo.PassportIssueDate));
                        //sqlCmd.Parameters.AddWithValue("@PassportExpiryDate", DateTime.Parse(objUserInfo.PassportExpireDate));
                        if (objUserInfo.CitizenshipIssueDate == "")
                        {
                            sqlCmd.Parameters.AddWithValue("@CitizenIssueDate", defaultdate);
                        }
                        else
                        {
                            sqlCmd.Parameters.AddWithValue("@CitizenIssueDate", DateTime.ParseExact(objUserInfo.CitizenshipIssueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture)
                                                .ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
                            //sqlCmd.Parameters.AddWithValue("@CitizenIssueDate", DateTime.Parse(objUserInfo.CitizenshipIssueDate).ToString("MM/dd/yyyy"));
                        }

                        if (objUserInfo.BSCitizenshipIssueDate == "")
                        {
                            sqlCmd.Parameters.AddWithValue("@BSCitizenIssueDate", "2006-01-01");
                        }
                        else
                        {
                        ...
                        if (objUserInfo.LicenseExpireDate == "" || objUserInfo.LicenseIssueDate == "")
                        {
                        ...
                        {
                            sqlCmd.Parameters.AddWithValue("@LicenseExpiryDate", DateTime.ParseExact(objUserInfo.LicenseExpireDate, "dd/MM/yyyy", CultureInfo.InvariantCulture)
                                                .ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
                            sqlCmd.Parameters.AddWithValue("@LicenseIssueDate", DateTime.ParseExact(objUserInfo.LicenseIssueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture)
                                                .ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
                            //sqlCmd.Parameters.AddWithValue("@LicenseExpiryDate", DateTime.Parse(objUserInfo.LicenseExpireDate).ToString("MM/dd/yyyy"));
                            //sqlCmd.Parameters.AddWithValue("@LicenseIssueDate", DateTime.Parse(objUserInfo.LicenseIssueDate).ToString("MM/dd/yyyy"));
                        }

                        if (objUserInfo.BSLicenseExpireDate == "" || objUserInfo.BSLicenseIssueDate == "")
                        {
                            sqlCmd.Parameters.AddWithValue("@BSLicenseExpiryDate", "2006-01-01");
                            sqlCmd.Parameters.AddWithValue("@BSLicenseIssueDate", "2006-01-01");
                        }
                        else
                        {
                        ...
                        if (objUserInfo.PassportExpireDate == "" || objUserInfo.PassportIssueDate == "")
                        {
                        ...
                        else
                        {
                            sqlCmd.Parameters.AddWithValue("@PassportIssueDate", DateTime.ParseExact(objUserInfo.PassportIssueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture)
                                                .ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
                            sqlCmd.Parameters.AddWithValue("@PassportExpiryDate", DateTime.ParseExact(objUserInfo.PassportExpireDate, "dd/MM/yyyy", CultureInfo.InvariantCulture)
                                                .ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
                        ...
                        sqlCmd.Parameters.AddWithValue("@Remark", "Register By Bank Admin THAILI DIGITAL ACTYPE: ");
                        ...
                        ret = sqlCmd.ExecuteNonQuery();
                        if (objUserInfo.Mode.Equals("IBUP", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ret = Convert.ToInt32(sqlCmd.Parameters["@RegIDOut"].Value);
