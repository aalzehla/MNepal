    ...
    public class UserProfileUserModel
    {
        ...
        public DataTable GetAllUserProfileInfo(UserProfilesInfo objUserInfo)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("[s_MNUserProfileInfo]", conn))
                    {
        ...
        public DataTable GetAdminProfileUserInformation(UserProfilesInfo objUserInfo)
        {
            ...
            try
            {
                ...
                using (var command = database.GetStoredProcCommand("[s_MNListAdminProfile]"))
                {
        ...
        public DataSet GetAdminUserMenuListInformation(UserProfilesInfo objUserInfo)
        {
            ...
            {
                database = DatabaseConnection.GetDatabase();
                using (var command = database.GetStoredProcCommand("[s_MNVMAdminUserProfile]"))
                {
        ...
        public List<MNMenuTable> GetMenu()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("Select * from MNMenuTable (nolock) where CanBeAssigned=1 order by Hierarchy", conn))
                    {
