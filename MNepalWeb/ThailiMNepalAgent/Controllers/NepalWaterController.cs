...
namespace ThailiMNepalAgent.Controllers
{
    public class NepalWaterController : Controller
    {
        ...
        {
            string Query_refStan = "select refStan from MNPaypointResponse where account='" + KPObj.CustomerID + "' AND serviceCode='" + KPObj.NWCounter + "' AND ClientCode='" + KPObj.ClientCode + "' AND UserName='" + KPObj.UserName + "'";
            DataTable dt = new DataTable();
