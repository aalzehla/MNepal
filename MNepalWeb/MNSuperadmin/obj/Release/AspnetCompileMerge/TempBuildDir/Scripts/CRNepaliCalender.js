...
jQuery(document).ready(function ($) {
    ...
    $('#BSCitizenshipIssueDate, #BSLicenseIssueDate, #BSLicenseExpireDate,#BSDateOfBirth').nepaliDatePicker({
        npdMonth: true,
        npdYear: true,
    ...
    $('input[type=dropdown][name=dateFormat]').change(function () {
        var val = $(this).val();
        if (val != "BS") {
    ...
    $('input[type=dropdown][name=LicensedateFormat]').change(function () {
        var val = $(this).val();
        if (val != "BS") {
