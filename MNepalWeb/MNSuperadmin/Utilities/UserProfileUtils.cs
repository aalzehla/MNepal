...
namespace MNSuperadmin.Utilities
{
    public class UserProfileUtils
    {
        ...
        public static DataTable GetAdminProfile()
        {
            ...
            {
                Mode = "GMSP" // GET MANAGE SUPER ADMIN PROFILE
            };
        ...
        #region "SUPER ADMIN USER PROFILE /ROLE SETUP"

        public static DataTable GetSuperAdminUserProfile(string ProfileCode)
        {
            var objUserModel = new UserProfileUserModel();

            return objUserModel.GetSuperAdminProfileNameInformation(ProfileCode);
        }
