...
namespace MNSuperadmin.Controllers
{
    ...
    public class SuperAdminController : Controller
    {
        ...
        public ActionResult Registration(FormCollection collection)
        {
            try
            {
                ...
                if (TempData["userType"] != null)
                {
                    ...
                    {
                        DataTable dtCheckUserName = RegisterUtils.GetCheckSuperAdminUserName(userInfo.UserName); //GetCheckUserName(userInfo.UserName);
                        if (dtCheckUserName.Rows.Count == 0)
                        {
                            if (collection.AllKeys.Any())
                            {
                                try
                                {
                                    int results = RegisterUtils.RegisterAdminInfo(userInfo);
                                    if (results > 0)
                                    {
                                        result = true;
                    ...
                    this.TempData["registration_message"] = result
                                                  ? "Registration information is successfully added. Please Check Approve Registration SuperAdmin and perform accordingly"
        ...
        #region 'Check Super Admin UserName '
        ...
        public ActionResult GetCheckingUserName(string Username)
        {
            if ((Username != "") || (Username != null))
            {
                ...
                DataTable dtableMobileNo = RegisterUtils.GetCheckSuperAdminUserName(Username);
        ...
        public ActionResult PasswordResetList()
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                List<UserInfo> RegistrationtList = new List<UserInfo>();
               // DataTable dtblRegistration = ProfileUtils.GetAdminProfile();
                DataTable dtblRegistration = ProfileUtils.GetSuperadminExceptOwn(userName);
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnCommand == "Reset")
                {
                    ...
                    if (isUpdated)
                    {
                        ...
                        this.TempData["message_class"] = messageClass;
                        return RedirectToAction("PasswordResetList", "SuperAdmin");
                    }
                    else
                    {
        ...
        #region "SuperAdmin Approve"

        // GET: SuperAdmin/ApproveList
        ...
        #region "SuperAdmin Approve Modify"

        // GET: SuperAdmin/ApproveModifyList
        ...
        #region SuperAdmin Modified Approve
        // GET: SuperAdmin
        ...
        public ActionResult EditModified(string clientCodeId)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                DataSet DSetMakerchecker = ProfileUtils.GetSuperAdminModifiedValue(clientCodeId);
        ...
        public ActionResult ApproveModifyAdmin(UserInfo model, string btnApprove)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnApprove.ToUpper() == "REJECT")
                {
                    ...
                    if (ret == 100)
                    {
                        displayMessage = "Superadmin" + model.Name + " has been Rejected. Please Check Modification Rejected and perform accordingly";
                        messageClass = CssSetting.SuccessMessageClass;
                    }
                    else if (ret == -1 || ret != 100)
                    {
                        displayMessage = "Error while rejecting Superadmin " + model.Name;
                        messageClass = CssSetting.FailedMessageClass;
                    }
                ...
                else if (btnApprove.ToUpper() == "APPROVE")
                {
                    ...
                    if (ret == 100)
                    {
                        displayMessage = "Modification Information for  Superadmin " + model.Name + " has successfully been approved.";
                        messageClass = CssSetting.SuccessMessageClass;
                    }
                    else if (ret == -1 || ret != 100)
                    {
                        displayMessage = "Error while approving Superadmin Information";
                        messageClass = CssSetting.FailedMessageClass;
                    }
        ...
        #region SuperAdmin Rejected List
        ...
        public ActionResult ApproveAdminRegRejected(UserInfo model, string btnCommand)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnCommand.ToUpper() == "SUBMIT")
                {
                    ...
                    if (ret)
                    {
                        displayMessage = "Registration Information for  Superadmin " + model.Name + " has been modified. Please Check Approve Registration Superadmin and perform accordingly.";
                        messageClass = CssSetting.SuccessMessageClass;
                    }
                    else
                    {
        ...
        #region APPROVE SUPERADMIN REGISTRATION LIST
        [HttpGet]
        public ActionResult ApproveSuperAdminList(string Key, string Value)
        {
            string userName = (string)Session["LOGGED_USERNAME"];
            string clientCode = (string)Session["LOGGEDUSER_ID"];
            string name = (string)Session["LOGGEDUSER_NAME"];
            ...
            if (TempData["userType"] != null)
            {
                ...
                var adminInfo = CustomerUtils.GetUnApproveAdminProfile("superadmin", UserName);
        ...
        //View Approve SuperAdmin Registration Details
        //ViewApproveSuperAdmin
        ...
        public ActionResult ApproveRegisterAdmin(UserInfo model, string btnApprove)
        {
            ...
            if (TempData["userType"] != null)
            {
                ...
                if (btnApprove.ToUpper() == "REJECT")
                {
                    ...
                    if (ret == 1)
                    {
                        displayMessage = "Superadmin" + model.Name + " has been Rejected. Please Check Rejectlist and perform accordingly";
                        messageClass = CssSetting.SuccessMessageClass;
                    }
                    else if (ret == -1 || ret != 100)
                    {
                    ...
                    this.TempData["custapprove_messsage"] = displayMessage;
                    this.TempData["message_class"] = messageClass;
                    return RedirectToAction("ApproveSuperAdminList");
                ...
                else if (btnApprove.ToUpper() == "APPROVE")
                {
                    ...
                    if (ret == 1)
                    {
                       ...
                       bool passChange= PasswordUtils.ResetPassword(userInfo);
                        ...
                        {
                            string Subject = "New Superadmin Registration";
                            string MailSubject = "<span style='font-size:15px;'><h4>Dear " + userInfo.Name + ",</h4>";
                        ...
                        displayMessage = "Registration Information for  Superadmin " + model.Name + " has successfully been approved.";
                        messageClass = CssSetting.SuccessMessageClass;
                        }
                        else
                        {
        ...
        public ContentResult PasswordResetApprove(string ClientCode, string Name, string ActionClick)
        {
            ...
            try
            {
                ...
                if (ActionClick == "Approve")
                {
                    ...
                    if ((info.Password != "") && (info.ClientCode != "") && (info.Status == "SAPR"))
                    {
