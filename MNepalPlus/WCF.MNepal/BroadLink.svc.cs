...
namespace WCF.MNepal
{
	...
	{
        [OperationContract]
        #region"Check Paypoint BroadLink"
        [WebInvoke(Method = "POST",
                 ResponseFormat = WebMessageFormat.Json)]
        public string BroadLinkCheckpayment(Stream input)
        {
            ...
            string note = "utility payment for BroadLink. Customer ID=" + qs["account"];
            string src = qs["src"];
            string result = "";
            ...
            PaypointModel reqCPPaypointBroadLinkInfo = new PaypointModel();//to store data request of CP which is also commmon in nea
            PaypointModel resCPPaypointBroadLinkInfo = new PaypointModel();//to store data response of CP which is also commmon in nea

            //PaypointModel resPaypointPaymentInfo = new PaypointModel();
            PaypointModel resPaypointBroadLinkPaymentInfo = new PaypointModel();//to store data of Response of CP only
            ...
            try
            {
                ...
                reqCPPaypointBroadLinkInfo = new PaypointModel()
                {
                ...
                using (WebClient wc = new WebClient())
                {
                    ...
                    if (xElem.Attribute("Result").Value == "000")
                    {
                        ...
                        resPaypointBroadLinkPaymentInfo = new PaypointModel()
                        {
                        ...
                        int resultsPayments = PaypointUtils.PaypointBroadLinkInfo(resPaypointBroadLinkPaymentInfo);
                    }
                    else
                    {
                        keyrlt = xElem.Attribute("Key").Value;
                    ...
                    resCPPaypointBroadLinkInfo = new PaypointModel()
                    {
            ...
            try
            {
                int resultsReqCP = PaypointUtils.RequestCPPaypointInfo(reqCPPaypointBroadLinkInfo);
                int resultsResCP = PaypointUtils.ResponseCPPaypointInfo(resCPPaypointBroadLinkInfo);
            ...
            else if (statusCode == "200")
            {
                ...
                var v = new
                {
                    ...
                    retrievalRef = resCPPaypointBroadLinkInfo.retrievalReferenceResCP,
                    refStanCK = resCPPaypointBroadLinkInfo.refStanResCP,
                };
        ...
        public string executepayment(Stream input)
        {
            ...
            string pin = qs["pin"];
            string note = "utility payment for BroadLink. Customer Name=" + qs["account"];//+ ". " + qs["note"];
            string src = qs["src"];
            string result = "";
            string sessionID = qs["tokenID"];
            string resultMessageResCP = "";
            ...
            PaypointModel reqEPPaypointBroadLinkInfo = new PaypointModel();
            PaypointModel resEPPaypointBroadLinkInfo = new PaypointModel();

            PaypointModel reqGTPaypointBroadLinkInfo = new PaypointModel();
            PaypointModel resGTPaypointBroadLinkInfo = new PaypointModel();
                        ...
                        if (rltCheckPaymt == "000")//go if CP Response is 000
                        {
                            ...
                            do
                            {
                                ...
                                else
                                {
                                    ...
                                    reqEPPaypointBroadLinkInfo = new PaypointModel()
                                    {
                                    ...
                                    using (WebClient wcExecPay = new WebClient())
                                    {
                                        ...
                                        resEPPaypointBroadLinkInfo = new PaypointModel()
                                        {
                            ...
                            try
                            {
                                int resultsReqEP = PaypointUtils.RequestEPPaypointInfo(reqEPPaypointBroadLinkInfo);
                                int resultsResEP = PaypointUtils.ResponseEPPaypointInfo(resEPPaypointBroadLinkInfo);
                            ...
                            if (compResultResp == "000")
                            {
                                ...
                                else if (compResultResp != "")
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        reqGTPaypointBroadLinkInfo = new PaypointModel()
                                        {
                                        ...
                                        using (WebClient wcGetTran = new WebClient())
                                        {
                                            ...
                                            resGTPaypointBroadLinkInfo = new PaypointModel()
                                            {
                                    ...
                                    try
                                    {
                                        ...
                                        int resultsReqGTP = PaypointUtils.RequestGTPaypointInfo(reqGTPaypointBroadLinkInfo);
                                        int resultsResGTP = PaypointUtils.ResponseGTPaypointInfo(resGTPaypointBroadLinkInfo);
