    ...
    public class TransactionLimitUserModel
    {
        ...
        public DataTable GetWalletTransactionLimit(MNClientExt objUserLimitInfo)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("dbo.s_MNGetProfileWalletLimitNew", conn))
                    {
                        cmd.Parameters.AddWithValue("@UserName", objUserLimitInfo.UserName);
                        cmd.Parameters.AddWithValue("@sourceCode", objUserLimitInfo.WalletProfileCode); //WalletProfileCode == sc (sourceCode)
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        #region Wallet Transaction Limit NonKYC Information
        public DataTable GetWalletTransactionLimitNonKYC(MNClientExt objUserLimitInfo)
        {
            DataTable dtableResult = null;
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("s_MNGetProfileWalletLimitNonKYC", conn))
                    {
                        cmd.Parameters.AddWithValue("@UserName", objUserLimitInfo.UserName);
                        cmd.Parameters.AddWithValue("@sourceCode", objUserLimitInfo.WalletProfileCode); //WalletProfileCode == sc (sourceCode)
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        #region Wallet Transaction Limit With KYC WithOUT Bank Link Information
        public DataTable GetWalletTranLimitWithKYCOutBank(MNClientExt objUserLimitInfo)
        {
            DataTable dtableResult = null;
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("s_MNGetProfileWalletLimitWithKYCOutBank", conn))
                    {
                        cmd.Parameters.AddWithValue("@UserName", objUserLimitInfo.UserName);
                        cmd.Parameters.AddWithValue("@sourceCode", objUserLimitInfo.WalletProfileCode); //WalletProfileCode == sc (sourceCode)
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        #region Check KYC
        public DataTable CheckKYC(MNClientExt objUserLimitInfo)
        {
            DataTable dtableResult = null;
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("dbo.s_MNCheckKYC", conn))
                    {
                        cmd.Parameters.AddWithValue("@UserName", objUserLimitInfo.UserName);
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable CheckBankKYC(MNClientExt objUserLimitInfo)
        {
            DataTable dtableResult = null;
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("dbo.s_MNCheckBankKYC", conn))
                    {
                        cmd.Parameters.AddWithValue("@UserName", objUserLimitInfo.UserName);
                        cmd.CommandType = CommandType.StoredProcedure;
