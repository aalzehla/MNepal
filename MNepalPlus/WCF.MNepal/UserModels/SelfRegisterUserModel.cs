    ...
    public class SelfRegisterUserModel
    {
        ...
        public int RegisterUsersInfo(UserValidate objUserInfo)
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNSelfRegistrationKYC]", sqlCon)) //s_MNSelfRegistration
                    {
                        ...
                        sqlCmd.Parameters.AddWithValue("@BSDateOfBirth", "");
                        ...
                        if (objUserInfo.Mode.Equals("ISRKYC", StringComparison.InvariantCultureIgnoreCase))
                        {
        ...
        #region "QuickSelfRegister "

        public PassAndPin QuickSelfRegisterUsersInfo(UserValidate objUserInfo)
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                using (sqlCon = new SqlConnection(DatabaseConnection.ConnectionString()))
                {
                    ...
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNQuickSelfWebReg]", sqlCon))
                    {
                        ...
                        sqlCmd.Parameters.AddWithValue("@MName", objUserInfo.MName);
                        sqlCmd.Parameters.AddWithValue("@LName", objUserInfo.LName);
                        sqlCmd.Parameters.AddWithValue("@retrievalRef", objUserInfo.RetRef);
                        sqlCmd.Parameters.AddWithValue("@Remark", "Quick Register App THAILI DIGITAL ACTYPE: ");
                        ...
                        ret = sqlCmd.ExecuteNonQuery();
                        if (objUserInfo.Mode.Equals("QISR", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ret = Convert.ToInt32(sqlCmd.Parameters["@RegIDOut"].Value);
            ...
            PassAndPin passAndPin = new PassAndPin(objUserInfo.Password, objUserInfo.PIN, ret);
            return passAndPin;
        }

        public int InsertResponseQuickSelfReg(UserValidate objUserInfo)
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                using (sqlCon = new SqlConnection(DatabaseConnection.ConnectionString()))
                {
                    ...
                    using (SqlCommand sqlCmd = new SqlCommand("[s_RegResponseInsert]", sqlCon))
                    {
                        ...
                        sqlCmd.Parameters.AddWithValue("@UserName", objUserInfo.UserName);
                        sqlCmd.Parameters.AddWithValue("@retrievalRef", objUserInfo.RetRef);
                        sqlCmd.Parameters.AddWithValue("@StatusCode", objUserInfo.StatusCode);
                        sqlCmd.Parameters.AddWithValue("@StatusMsg", objUserInfo.StatusMsg);
                        ...
                        ret = sqlCmd.ExecuteNonQuery();
                        if (objUserInfo.Mode.Equals("RQISR", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ret = Convert.ToInt32(sqlCmd.Parameters["@RegIDOut"].Value);
        ...
        public int LinkBankAccount(LinkBankAccount objUserInfo)
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNCustLinkBankAccount]", sqlCon))
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;

                        sqlCmd.Parameters.AddWithValue("@MobileNumber", objUserInfo.MobileNumber);
                        sqlCmd.Parameters.AddWithValue("@Name", objUserInfo.Name);
                        sqlCmd.Parameters.AddWithValue("@AccountNumber", objUserInfo.AccountNumber);
                        sqlCmd.Parameters.AddWithValue("@DateOfBirth", objUserInfo.DateOfBirth);
                        sqlCmd.Parameters.AddWithValue("@mode", "IILBT");
        ...
        public int RegistrationByAgent(UserValidate objUserInfo, string retRef)
        {
            SqlConnection sqlCon = null;
            int ret;
            try
            {
                ...
                {
                    sqlCon.Open();
                    using (SqlCommand sqlCmd = new SqlCommand("[s_MNRegistrationByAgent]", sqlCon)) //s_MNSelfRegistration
                    {
                        sqlCmd.CommandType = CommandType.StoredProcedure;
                        ...
                        sqlCmd.Parameters.AddWithValue("@Remark", "Register By Agent App THAILI DIGITAL ACTYPE: ");
                        ...
                        ret = sqlCmd.ExecuteNonQuery();
                        if (objUserInfo.Mode.Equals("AISR", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ret = Convert.ToInt32(sqlCmd.Parameters["@RegIDOut"].Value);
