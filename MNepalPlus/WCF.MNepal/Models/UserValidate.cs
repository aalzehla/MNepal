...
namespace WCF.MNepal.Models
{
    public class UserValidate
    {
        ...
        public HttpPostedFileBase RegCertiPic { get; set; }
        public HttpPostedFileBase TaxClearFrontPic { get; set; }
        public HttpPostedFileBase TaxClearBackPic { get; set; }
        ...
        public UserValidate(string UserName, string Password, string Pin, string userType, string OTPCode, string Source, string FName, string MName, string LName)
        {
            this.UserName = UserName;
            this.Password = Password;
            this.PIN = Pin;
        ...
        public UserValidate(string UserName, string Password, string Pin, string userType, string OTPCode, string Source, string FName, string MName, string LName, string RetRef)
        {
            this.UserName = UserName;
            this.Password = Password;
            this.PIN = Pin;
        ...
        public UserValidate(string UserName, string RetRef, string StatusCode, string StatusMsg)
        {
            this.UserName = UserName;
            this.RetRef = RetRef;
