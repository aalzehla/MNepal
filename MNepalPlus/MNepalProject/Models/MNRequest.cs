...
namespace MNepalProject.Models
{
    public class MNRequest
    {
        ...
        // For Coupon Payment
        public MNRequest(string OriginID, string OriginType, string ServiceCode, string SourceBankCode, string SourceBranchCode, string SourceAccountNo, string DestBankCode, string DestBranchCode, string DestAccountNo, float Amount, string FeeId, string TraceNo, DateTime TranDate, string RetrievalRef, string Desc1, string Desc2,string Desc3, /*string OTraceNo, string OTranDateTime,*/ string IsProcessed,string Remark, string ReverseStatus)
        {
            this.OriginID = OriginID;
            this.OriginType = OriginType;
            this.ServiceCode = ServiceCode;
            ...
            */
            this.IsProcessed = IsProcessed;
            this.Remark = Remark;
            this.ReversalStatus = ReverseStatus;
        }
